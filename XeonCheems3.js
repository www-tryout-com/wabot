...
const ucap = moment(Date.now()).tz('America/Mexico_City').locale('id').format('a')
// date
...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `Síguenos en Instagram: https://www.instagram.com/sticker._.factory/`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/cheemspic.jpg`),"sourceUrl": `${linkz1}`}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `Síguenos en Instagram: https://www.instagram.com/sticker._.factory/`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/cheemspic.jpg`),"sourceUrl": `${linkz2}`}}}, { quoted: m})
        }
        //auto reply by xeon
...
dataa = await fetchJson(`https://api.countapi.xyz/hit/CheemsBot${moment.tz('America/Mexico_City').format('DDMMYYYY')}/visits`)
...
teks = `Escriba .owner para unirse a su grupo de WhatsApp`
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'), `${watermark}`, `${botname}`, "+1 (209) 443-3473@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
reply(`\`\`\`「 Group Link Detected 」\`\`\`\n\nNo serás expulsado por un bot porque lo que envíaste es un enlace a este grupo.`)
...
bvl = `\`\`\`「 Wa.me Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace wa.me, el administrador puede enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Ha sido expulsado por enviar un enlace de video de YouTube en este grupo`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antiWame)
...
bvl = `\`\`\`「 Gc Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de grupo, el administrador puede enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 YoutTube Video Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de video de YouTube, el administrador puede enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 YoutTube Channel Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de canal de YouTube, el administrador puede enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Ha sido expulsado por enviar el enlace del canal de YouTube en este grupo`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
if (!isBotAdmins) return
bvl = `\`\`\`「 Instagram Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de Instagram, el administrador puede enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Ha sido expulsado por enviar un enlace de Instagram en este grupo`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
if (!isBotAdmins) return
bvl = `\`\`\`「 Facebook Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de Facebook, el administrador es libre de enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Ha sido expulsado por enviar un enlace de Facebook en este grupo`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
if (AntiLinkTelegram)
if (!isBotAdmins) return
bvl = `\`\`\`「 Telegram Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de Telegram, el administrador puede enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Ha sido expulsado por enviar un enlace de Telegram en este grupo`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
if (!isBotAdmins) return
bvl = `\`\`\`「 Tiktok Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de tiktok, el administrador puede enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Ha sido expulsado por enviar un enlace tiktok en este grupo`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
if (!isBotAdmins) return
bvl = `\`\`\`「 Twitter Link Detected 」\`\`\`\n\nEl administrador ha enviado un enlace de Twitter, el administrador es libre de enviar cualquier enlace`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Ha sido expulsado por enviar un enlace de Twitter en este grupo`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
...
${themeemoji} Clock : ${moment.tz('America/Mexico_City').format('HH:mm:ss')} 
${themeemoji} Date : ${moment.tz('America/Mexico_City').format('DD/MM/YYYY')}
${themeemoji} MessageType : ${m.mtype}`
XeonBotInc.sendTextWithMentions(m.chat, teks, m)
await sleep(500)
m.copyNForward(m.chat, true, { readViewOnce: true }).catch(_ => reply(`Tal vez ha sido abierto por un bot`))
}
...
//FAKE CONTACT
const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `+1 (209) 443-3473 -1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Click to chat\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
//FAKEREPLY PRODUCT
const ftoko = {
key: {
fromMe: false,
...
//fake gif by xeon
	 ...
	 { remoteJid: "+1 (209) 443-3473-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
                 "title": `Xeon`,
...
"message": {
"groupInviteMessage": {
"groupJid": "+1 (209) 443-3473-1616169743@g.us",
...
└┬────────────┈ 
   │✑  Por favor selecciona algún botón de abajo.
   └─────────────┈`
...
//cases starts here
switch(command) {
	case 'alive': case 'panel': case 'list': case 'mnunosirve': case 'helnosirve': case '': {
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
        	...
        	XeonBotInc.sendMessage(m.chat, { caption: menulist, fileName: `${ownername}`, templateButtons: buttonmenu, footer: `${botname}`, mentionedJid: [m.sender] })
                        }
                     }
            break
case 'menuxxx':
...
case 'sc': case 'script': case 'donate': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'sourcecode': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
teks = `*「 ${global.botname} Project 」*\n\nInstagram: ${global.websitex}\nPayPal: https://www.paypal.com/paypalme/stickerfactorydonate/\n\nNo olvides donar 💲`
let buttons = [
...
mediaType:1,
mediaUrl: 'https://i.postimg.cc/FKSTBvkc/donate.png',
sourceUrl: "https://i.postimg.cc/FKSTBvkc/donate.png"
}}
}
...
replay('Success in unbanning the gc')
  ...
  await XeonBotInc.sendButtonText(m.chat, buttonsntnsfw, `Por favor, haga clic en el botón de abajo\n\nBan para Banear\nUnban quitar el ban`, `${global.botname}`, m)
  }
  }
  break
case 'botgrups':
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
reply(` ¡No olvides unirte!

*GROUP 1*
https://chat.whatsapp.com/ENLguN9qXct7Fd0bljlrHv`)
break
case 'getsxvdxcmd': {
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
XeonBotInc.sendMessage(from, {sticker:{url:"https://i.postimg.cc/wMpGFLRN/stf.jpg"}}, {quoted:m})
XeonBotInc.sendMessage(from, {sticker:{url:"https://i.postimg.cc/wMpGFLRN/stf.jpg"}}, {quoted:m})
XeonBotInc.sendMessage(from, {sticker:{url:"https://i.postimg.cc/wMpGFLRN/stf.jpg"}}, {quoted:m})
}
break
...
console.log(anu)
XeonBotInc.sendMessage(from,{image:{url:anu}, caption:"Aquí tienes, disfrutalo. 🥰"},{quoted:m})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendMessage(from, {image:{url:teds}, caption:"Aquí tienes, disfrutalo. 🥰"}, {quoted:m})
} else if (args[0] === 'glow') {
if (args.length < 2) return reply(`Example :\n${prefix + command + ' ' + args[0]} ${ownername}`)
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
	reply(mess.wait)
if (!q) return reply(`¿Qué película quieres buscar?\nEjemplo: ${prefix}film Spiderman`)
xeonkey.Film(q)
...
if (isBanChat) return reply(mess.banChat)
            let buttons = [
                ...
                let buttonMessage = {
                    ...
                    caption: `Aquí tienes, disfrutalo. 🥰`,
                    footer: `${botname}`,
                    buttons: buttons,
                    headerType: 4
                }
...
for (let i of anu) {
 teks += `\n\nProfile : @${i.id.split('@')[0]}\nChat : ${i.unreadCount}\nLastchat : ${moment(i.conversationTimestamp * 1000).tz("America/Mexico_City").format("DD/MM/YYYY HH:mm:ss")}`
}
XeonBotInc.sendTextWithMentions(m.chat, teks, m)
}
break
...
for (let i of anu) {
 ...
 teks += `\n\nName : ${metadata.subject ? metadata.subject : "undefined"}\nOwner : ${loldd ? '@' + loldd.split("@")[0] : "undefined"}\nID : ${metadata.id ? metadata.id : "undefined"}\nMade : ${metadata.creation ? moment(metadata.creation * 1000).tz('America/Mexico_City').format('DD/MM/YYYY HH:mm:ss') : "undefined"}\nMember : ${metadata.participants.length ? metadata.participants.length : "undefined"}`
}
XeonBotInc.sendTextWithMentions(m.chat, teks, m)
}
break
...
case 'inspect': case 'inspectgclink': case 'inspectgrouplink': {
	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!args[0]) return reply("¿Dónde está el link?")
...
${themeemoji} Subject update at : ${res.content[0].attrs.s_t ? moment(res.content[0].attrs.s_t *1000).tz("America/Mexico_City").format("DD-MM-YYYY, HH:mm:ss") : "undefined"}
${themeemoji} Create by : ${res.content[0].attrs.creator ? "@" + res.content[0].attrs.creator.split("@")[0] : "undefined"}
${themeemoji} Create at : ${res.content[0].attrs.creation ? moment(res.content[0].attrs.creation * 1000).tz("America/Mexico_City").format("DD-MM-YYYY, HH:mm:ss") : "undefined"}
...
${themeemoji} Desc update at : ${res.content[0].content[0].attrs.t ? moment(res.content[0].content[0].attrs.t * 1000).tz("America/Mexico_City").format("DD-MM-YYYY, HH:mm:ss") : "undefined"}
...
▸ Subject update at : ${res.content[0].attrs.s_t ? moment(res.content[0].attrs.s_t *1000).tz("America/Mexico_City").format("DD-MM-YYYY, HH:mm:ss") : "undefined"}
▸ Create by : ${res.content[0].attrs.creator ? "@" + res.content[0].attrs.creator.split("@")[0] : "undefined"}
▸ Create on : ${res.content[0].attrs.creation ? moment(res.content[0].attrs.creation * 1000).tz("America/Mexico_City").format("DD-MM-YYYY, HH:mm:ss") : "undefined"}
...
▸ Desc update at : ${res.content[0].content[0].attrs.t ? moment(res.content[0].content[0].attrs.t * 1000).tz("America/Mexico_City").format("DD-MM-YYYY, HH:mm:ss") : "undefined"}
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./XeonMedia/theme/cheemsthumb.jpg'), `${global.watermark}`, `${global.botname}`, "+1 (209) 443-3473@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await XeonBotInc.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
replay("Succes!")
} else {
...
case 'igstory': case 'instagramstory': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!args[0]) return reply(`Example :\n${prefix + command} sticker._.factory`)
try {
...
case 'igdl': case 'instagram': case 'instagramreels': case 'igreels': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!args[0]) return reply(`Example :\n${prefix + command} https://www.instagram.com/reel/CWrlm3ZNzR8/`)
try {
...
if (isBanChat) return reply(mess.banChat)
   ...
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)	             
             if (!text) return reply(`¿Dónde está el link?`)
...
break
  case 'tiktok':{
  	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
  if (!q) return reply('¿Dónde está el link?')
  reply(mess.wait)
...
texttk = `¿Quieres descargar sin marca de agua o solo el audio?
_Por favor, elija el botón de abajo_`
let buttons = [
{buttonId: `ttnowm ${q}`, buttonText: {displayText: 'Sin Marca de Agua ❌'}, type: 1},
{buttonId: `ttaud ${q}`, buttonText: {displayText: 'Solo el Audio 🎶'}, type: 1}
]
let buttonMessage = {
...
break
 ...
 reply(mess.error) 
   ...
   const xeonytiktoknowm = musim_rambutan.result.nowatermark
    XeonBotInc.sendMessage(from, { video: { url: xeonytiktoknowm }, caption: "Aquí tienes, disfrutalo. 🥰" }, { quoted: m })
   }
  break
  case 'tiktokaudio':
case 'tiktokmusic':
case 'ttaud':{
	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
  if (!q) return reply('¿Dónde está el audio?')
  if (!q.includes('tiktok')) return reply(`¡Ese no es un enlace de tiktok!`)
   const musim_rambutan = await XeonBotIncTiktok(`${q}`).catch(e => {
 reply(mess.error) 
} )
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, { video: { url: media.dl_link }, jpegThumbnail:buf, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `Aquí tienes, disfrutalo. 🥰` }, { quoted: m }).catch((err) => reply(mess.error))
            }
            break
            case 'ytdl': {
            	if (isBan) return reply(mess.ban)
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
teks = `Aquí tienes, disfrutalo. 🥰`
buffer = `https://api.dapuhy.xyz/api/randomimage/batues?apikey=0gly81wDky`
XeonBotInc.sendMessage(from, {image:{url:buffer}, caption:"Aquí tienes, disfrutalo. 🥰"}, {quoted:m})
break
case 'ytmp32':
  case 'youtubemp32':{
  	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
   reply(mess.wait)
  if (args.length < 1) return reply('¿Dónde está el link?')
   try{
    await yta(args[0])
.then((res) => {
     const { dl_link } = res
...
if ((quoted.msg || quoted).seconds > 11) return reply('Máximo 10 seconds!')
let media = await quoted.download()
let encmedia = await XeonBotInc.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
reply(`Envía una Imagen/Video seguido de *${prefix + command}*\nEl video debe de durar de 1-9 Segundos`)
}
}
break
case 'wiki':
...
XeonBotInc.sendMessage(from, {image:{url:nye}, caption:"Aquí tienes, disfrutalo. 🥰"}, {quoted:m})
break			
case 'xxxanjing':
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
Available Formats: pdf, docx, pptx, xlsx`)
		...
		break
		    case 'nomerhoki': case 'nomorhoki': {
			   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                if (!Number(text)) return reply(`Example : ${prefix + command} +1 (209) 443-3473`)
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
xeony_buffer = await getBuffer(`https://stickerfactory.ml/`)
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    ...
                    sections: [{
								"title": "Nuevas Funciones de Sticker Factory",
								"rows": [
									{
										"title": "Other ☕",
...
await XeonBotInc.send5ButImg(from, `Hola! Bienvenido al Menú de Comandos de Sticker Factory.
Algunos de los comandos podrían NO estar disponibles por el momento, puedes consultar la lista completa de comandos en www.stickerfactory.ml/comandos` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "Instagram 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Web Site 🌐","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case 'ownermenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
var unicorn = await getBuffer(picak+'Owner Menu')
await XeonBotInc.send5ButImg(from, `[Solo Personal Autorizado puede usar este comando]` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case 'groupmenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
var unicorn = await getBuffer(picak+'Group Menu')
await XeonBotInc.send5ButImg(from, `[Solo Personal Autorizado puede usar este comando] o puedes consultarla en www.stickerfactory.ml/comandos` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case 'rpgmenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
await XeonBotInc.send5ButImg(from, `No hay Sonidos para mostrar.` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "YouTube 📍","url": `${websitex}`}},{"urlButton": {"displayText": "Script🔖","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate 🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner 👤","id": 'owner'}}] )
break
case 'gamemenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
case 'tqtt': 
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
reply(`Thanks to All Development Team of *Sticker Factory*, If u want to send a personalized message, send it to soporte@stickerfactory.ml`)
break
default:
if (budy.startsWith('=>')) {
if (!isCreator) return reply(mess.owner)
